...
model.APInlet<-aov(DelPrete.orig$APInlet ~ DelPrete.orig$Gender * DelPrete.orig$LocationR + DelPrete.orig$Femur.Head.Adj)

results<-Anova(model.APInlet, test="F"
               )
results
...
```{r}
postHocs <- glht(model = model.APInlet)
summary(postHocs)
```
...
model.APOutlet<-aov(DelPrete.orig$APOutlet ~ DelPrete.orig$Gender * DelPrete.orig$LocationR + DelPrete.orig$Femur.Head.Adj)

results<-Anova(model.APOutlet, test="F"
               )
results
...
```{r}
postHocs <- glht(model = model.APOutlet)
summary(postHocs)
```
...
model.Bispinous<-aov(DelPrete.orig$Bispinous ~ DelPrete.orig$Gender * DelPrete.orig$LocationR + DelPrete.orig$Femur.Head.Adj)

results<-Anova(model.Bispinous, test="F"
               )
results
...
```{r}
postHocs <- glht(model = model.Bispinous)
summary(postHocs)
```
...
model.TDOutlet<-aov(DelPrete.orig$TDOutlet ~ DelPrete.orig$Gender * DelPrete.orig$LocationR + DelPrete.orig$Femur.Head.Adj)

results<-Anova(model.TDOutlet, test="F"
               )
results
...
```{r}
postHocs <- glht(model = model.TDOutlet)
summary(postHocs)
```
...
model.PelvicBreadth<-aov(DelPrete.orig$PelvicBreadth ~ DelPrete.orig$Gender * DelPrete.orig$LocationR + DelPrete.orig$Femur.Head.Adj)

results<-Anova(model.PelvicBreadth, test="F"
               )
results
...
```{r}
postHocs <- glht(model = model.PelvicBreadth, linfct = mcp(LocationR = "Tukey"))
summary(postHocs)
```
